...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <footerColor>#FFC20E</footerColor>
    <headerColor>#FFC20E</headerColor>
    ...
    <label>Wait List Console</label>
    <listPlacement>
        <location>full</location>
    </listPlacement>
    <listRefreshMethod>refreshList</listRefreshMethod>
    <logo>SharedDocuments/Sdhc_Logo_Waitlistconsole.png</logo>
    <primaryTabColor>#00457C</primaryTabColor>
